...
void bind_hdeq ()
{
    ...
    l_low2mid = GTK_SCALE (ajami_main_window_get_widget(ajami_get_main_window(), GTK_TYPE_SCALE, "cros_low_scale"));
    l_mid2high = GTK_SCALE (ajami_main_window_get_widget(ajami_get_main_window(), GTK_TYPE_SCALE, "cross_high_scale"));

    l_comp[0] = AJAMI_COMPRESSOR (ajami_main_window_get_widget(ajami_get_main_window(), AJAMI_TYPE_COMPRESSOR, "compressor_low"));
    l_comp[1] = AJAMI_COMPRESSOR (ajami_main_window_get_widget(ajami_get_main_window(), AJAMI_TYPE_COMPRESSOR, "compressor_mid"));
    l_comp[2] = AJAMI_COMPRESSOR (ajami_main_window_get_widget(ajami_get_main_window(), AJAMI_TYPE_COMPRESSOR, "compressor_high"));
...
void hdeq_low2mid_set (GtkRange *range)
{
    ...
    ajami_compressor_set_label (l_comp[1], label);
    free(label);
    ...
    ajami_compressor_set_label (l_comp[0], label);
    free(label);
...
void hdeq_mid2high_set (GtkRange *range)
{
    ...
    ajami_compressor_set_label (l_comp[2], label);
    free(label);
